      ...
      <Container>
        <div className="flex flex-col">
          <div className="flex items-center justify-between">
            ...
            <span className="text-lightGreen font-bold text-[22px]">13:30</span>
          ...
          <div className="flex flex-col items-center">
            <div className="flex flex-col p-3">
              <label className="font-bold text-center">Question 2</label>
              <Textarea
          ...
          <div className="flex justify-center gap-[22%]">
            ...
            <Button className="text-white text-[16px] px-6 py-2 disabled">
              Proceed
            </Button>
          </div>
        </div>
...
export default StudentModuleTestTwo;
