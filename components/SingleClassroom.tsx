    ...
    <div className="font-header md:mt-12 mt-24">
      ...
      <div className="grid font-subtext md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-3 mt-6">
        <div className="bg-white py-6 rounded-md">
          ...
          <div className="px-6 flex  space-x-2 pb-2">
            ...
            <div className="items-center mt-8">
                <p className="inline text-[14px]"><SiGoogleclassroom className="inline w-[18px] mr-2 h-[18px]"/>Alpha</p>
                <p className="mt-3 text-[13px]">Grade 12</p>
            </div>
        ...
        <div className="bg-white rounded-md py-6 px-6">
            ...
            <p className="my-3 text-[14px]">Use this link to invite students to join your live class.</p>
           <p className="text-blue-400 text-[14px] underline">http://web.schooledafrika09=ab/live</p>
