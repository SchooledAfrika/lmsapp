...
const ViewTestDetails: React.FC<ViewTestDetailsProps> = ({
  onClickChange,
  data,
  deleteTest,
  deleting,
            ...
            <div>
              ...
              <div className="shadow-lg mt-5">
                <div className="flex flex-col bg-[#FFFFFF] p-5">
                  ...
                  {data?.test[0].options.map((testOptions, index) => (
                    <label key={index} className="flex items-center gap-3">
                      ...
                      <input
                        ...
                        name="preferences"
                        checked={
                          testOptions == data?.test[0].answer ? true : false
                        }
              ...
              <div className="flex justify-between items-center my-5">
                ...
                <Button
                  onClick={() => deleteTest()}
                  className="bg-transparent text-[12px] font-bold text-[#FF6634] border border-[#FF6634]"
                >
                  {deleting ? "Deleting test..." : " Delete Test"}
                </Button>
              </div>
            </div>
          </div>
