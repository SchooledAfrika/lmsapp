      ...
      <div className="w-full ml-10 md:mt-10 mt-[35rem] mb-10 flex flex-col md:flex-row gap-16">
        <ul className="md:w-1/2 w-[80%] flex flex-col leading-[40px]">
          <li
            ...
            className="border-dotted border-l-2  border-lightGreen text-lightGreen"
          ...
          <li
            ...
            className="border-dotted border-l-2  border-lightGreen text-lightGreen"
          >
            <span className="ml-3 text-black text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ac
              interdum sapien,</span>
          ...
          <li
            ...
            className="border-dotted border-l-2  border-lightGreen text-lightGreen"
          >
            <span className="ml-3 text-black text-sm">+23491************</span>
          ...
          <li
            ...
            className="border-dotted border-l-2  border-lightGreen text-lightGreen"
          >
            <span className="ml-3 text-black text-sm">Schookafrika@gmail.edu.ng</span>
          ...
          <form className="w-full">
            <div className="md:flex hidden md:flex-row flex-col w-full items-center justify-between">
              <div>
                ...
                <br />
                <input type="text" className="ml-4  mb-6 p-2 mr-3 rounded-md bg-stone-200" />
              </div>
              <div>
                ...
                <br />
                <input type="phone" className="mr-12 mb-6  p-2 rounded-md bg-stone-200" />
              </div>
            </div>
            ...
            <br />
            <input type="text" className="w-[90%] md:hidden block mb-6 rounded-md ml-4 bg-stone-200  p-2" />
            <label className="ml-4 mt-8 md:hidden block text-sm">
              Phone Number<span className="text-red-600">*️</span>
            </label>
            <br />
            <input type="phone" className="w-[90%] md:hidden block mb-6 rounded-md ml-4 bg-stone-200  p-2" />
            <label className="ml-4 mt-8 text-sm">
              Email Address<span className="text-red-600">*️</span>
            </label>
            <br />
            <input type="email" className="w-[90%] mb-6 rounded-md ml-4 bg-stone-200  p-2" />
            <label className="ml-4 mt-8 text-sm">
            ...
            <Button className="ml-4 my-6 bg-lightGreen hover:bg-green-500 rounded-md text-white text-base mt-3 px-3 w-[90%]  py-2 text-center lg:block">Submit</Button>
          </form>
        </div>
      </div>
    </div>
