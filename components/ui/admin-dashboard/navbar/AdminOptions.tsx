      ...
      <PopoverTrigger asChild>
        <Button  className=" bg-slate-100 hover:bg-slate-100 text-black">
            ...
            <div className="flex flex-col">
              <h3 className="text-[14px]"> Admin Maurice</h3>
              <p className="text-[13px] inline">Administrator <IoIosArrowDown className="inline" /></p>
            </div>
      ...
      <PopoverContent className="w-80">
        <div className="grid gap-4">
          ...
          <div className="flex space-x-4 font-semibold ">
            ...
            <div className="flex flex-col">
              <h3 className="text-[14px]"> Admin Maurice</h3>
              <p className="text-[13px] text-slate-600">odomaurice@gmail.com</p>
            </div>
          ...
          <div className="grid gap-2">
            <div className="flex space-x-3 items-center">
             ...
             <Link href="/admin-dashboard/admin-profile" className="text-[14px] font-semibold">View Profile</Link>
            </div>
            <div className="grid gap-2">
            <div className="flex space-x-3 items-center">
              <IoSettingsOutline className="w-[20px] h-[20px] font-bold"/>
             <Link href="/admin-dashboard/admin-setting" className="text-[14px] font-semibold">Account Setting</Link>
            </div>
            </div>
            <hr/>
            <div className="grid gap-2">
            <div className="flex space-x-3 items-center pt-2">
             ...
             <Link href="" className="text-[14px] font-semibold">Log Out</Link>
            </div>
            </div>
