  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <Button
          variant="outline"
          className="bg-secondary hover:bg-green-700 w-full text-white text-[16px] px-6 py-7 my-3"
        >
          Proceed
        </Button>
      </AlertDialogTrigger>
      <AlertDialogContent className="sm:w-[400px] w-[300px] font-header">
        <AlertDialogHeader>
          ...
          <AlertDialogTitle className="text-[14px] inline font-bold">
            <MdVerified className="inline text-green-700 text-[16px]" /> KYC
