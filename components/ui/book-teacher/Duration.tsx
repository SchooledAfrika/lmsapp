    ...
    <div className="">
      <h3 className="text-xl font-bold">Book Session</h3>
        ...
        <div className="flex  mx-auto mt-8 mb-20 max-w-[360px] flex-col gap-3">
          <p className="text-lightGreen text-[15px] ml-8 font-semibold">Language & Duration</p>
          <p className="text-[14px] ml-8 font-semibold">Confirm the teacher's language of choice <br/> and select the session duration.</p>
