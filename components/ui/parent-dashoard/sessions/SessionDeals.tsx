...
import SingleSessionTable from "./SingleSessionTable";
        ...
        <div className="w-full">
          ...
          <div className="flex font-subtext  flex-col">
            ...
            <p className="text-[12px] my-3">
              Your class is visible and open to all on the platform dolor sit
              amet, consectetuer adipiscing elLorem ipsum dolor until{" "}
              <span className="text-lightGreen text-[13px] font-semibold">
                May 5, 2024
              </span>{" "}
            </p>
          </div>
