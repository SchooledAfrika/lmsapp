        ...
        <div className="sm:w-full md:w-[45%]">
          ...
          <form>
            ...
            <input
              ...
              className="my-3 p-5 bg-white outline-none rounded-[8px] w-full bg-white"
            />
            <br />
            <input
              type="password"
              ...
              className="mb-3 p-5 bg-white outline-none rounded-[8px] w-full bg-white"
            />
            <Button className="bg-secondary w-full text-white text-[16px] px-6 py-5 my-3 lg:block">
              Login
            </Button>
          </form>
          <div className="flex flex-col justify-center">
            <Button className="flex items-center bg-white w-full text-[16px] px-6 py-5 flex my-3">
              Sign in with google{" "}
              <Image src={Google} alt="Google" className="pl-2" />
            </Button>
            <Button className="flex items-center bg-white w-full text-[16.5px] px-6 py-5">
