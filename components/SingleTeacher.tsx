...
const SingleTeacher = () => {
  ...
  const { isLoading, isError, error, data } = useQuery({
    queryKey: ["addTeacher"],
    queryFn: async () => {
      const response = await fetch(`/api/add-teacher-by-school/${id}`);
            ...
            <div className=" flex flex-col space-y-4">
              <div className=" bg-white flex pl-3 pr-4 py-6 rounded-md  space-x-3 pb-2">
                <Image
                  ...
                  width={100}
                  height={100}
                  className="rounded-md w-[120px] h-[140px]"
                />
                ...
                <div className="items-center mt-8">
                  ...
                  >
                    <Link href="/" className="inline">
                      <CiMail className="inline mr-1 font-semibold" />
                      Contact
                    </Link>
                  </Button>
                </div>
              ...
              <div className="bg-white px-6 py-6 rounded-md">
                ...
                <p className="text-[13px]">
                  ...
                  dolor sit amet, consectetuer adipiscing eli Lorem ipsum dolor
                  sit amet, consectetuer adipiscing eliLorem ipsum dolor sit
                  amet, consectetuer adipiscing eliLorem ipsum dolor sit amet,
