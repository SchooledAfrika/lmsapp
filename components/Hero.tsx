            ...
            <div className="relative z-10   flex-1 ">
              ...
              <div className="flex flex-row justify-between items-center ">
                ...
                <p className="mt-6 text-lg font-subtext text-black">
                  Empower your child's journey with our comprehensive
                  educational solutions, nurturing their potential every step of
                  the way. Together, let's build a foundation for lifelong
                  success.
                </p>

                <h1 className="font-subtext font-semibold ss:text-[35px] text-[30px] text-black ss:leading-[50.8px] leading-[50px] w-full">
                  <span className="text-lightGreen">Better Future</span> for
                  your kids.
                </h1>
                <p className="mt-6 text-lg font-subtext text-black">
                  Empower your child's journey with our comprehensive
                ...
                <div className=" w-full relative mt-10 overflow-hidden  sm:mt-2   flex-1">
                  <Image
                    src={slider1}
                    alt=""
                    className="banner hidden rounded-full sm:block  w-[71px] h-[71px] absolute top-[350px] left-[50px]"
                  />
                  <Image
                    src={slider2}
                    alt=""
                    className="banner rounded-full hidden sm:block w-[71px] h-[71px] absolute top-[199px] left-[536px] z-[20px]"
                  />
                  <Image
                    src={slider3}
                    alt=""
                    className="banner rounded-full hidden sm:block w-[71px] h-[71px] absolute top-[163px] left-[536px] z-[10px]"
                  />
                  <Image
                    src={slider4}
                    alt=""
                    className="banner rounded-full hidden sm:block w-[71px] h-[71px] absolute left-[495px]"
                  />
                  <Image
                    src={slider5}
                    alt=""
                    className="banner rounded-full hidden sm:block w-[71px] h-[71px] absolute top-[350px] left-[500px]"
                  />
                  <Image
                    src={slider6}
                    alt=""
                    className="banner rounded-full hidden sm:block w-[71px] h-[71px] absolute top-[83px] left-[20px]"
                  />
                  <Image
                    src={slider7}
                    alt=""
                    className="banner rounded-full hidden sm:block w-[71px] h-[71px] absolute top-[128px] left-[10px]"
                  />
                  <Carousel
                    opts={{
                      loop: true,
