...
const PopularSubjectsCard = ({ icon, title, tutorNum, duration, rating }:Props) => {
    return (
      ...
      <div className="max-w-full mx-auto px-4 py-24">
        <div className="w-full flex flex-col items-center">
          ...
          <h2 className="text-2xl font-header text-lightGreen font-bold"> <span className="hidden  md:inline-flex w-20 md:w-60 mb-2 py-[.5px]  lgl:w-72 h-[.5px] bg-lightGreen mr-6"></span>
            Popular Subjects  <span className="hidden md:inline-flex mb-2 w-20 py-[.5px] md:w-60 lgl:w-72 h-[.5px] bg-lightGreen ml-6"></span>
          </h2>
          ...
          {showMore && (
            <>
              ...
              >
                ...
                <PopularSubjectsCard key={moreSubject.id} {...moreSubject} index={index}  />
      ))}</div>
