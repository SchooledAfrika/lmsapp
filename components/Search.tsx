...
const Search = () => {
  return (
    <div className="font-subtext ">
      ...
      <div className=" md:w-4/5 w-[90%] mt-16 md:mt-6 mx-auto  cursor-pointer font-header   h-[100px] md:mx-auto bg-white rounded-[50px] flex items-center justify-center p-4 shadow-md">
