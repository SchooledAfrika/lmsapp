...
const SingleStudent = () => {
  ...
  const { isLoading, isError, error, data } = useQuery({
    queryKey: ["addStudent"],
    queryFn: async () => {
      const response = await fetch(`/api/add-student-by-school/${id}`);
  ...
  return (
    <div className="font-header md:mt-12 mt-24">
      <div className="flex justify-between">
        ...
        <Link href="/school-dashboard/students" className="cursor-pointer">
          <Image
            src="/closeAlt.svg"
            alt="cancel"
            width={100}
      ...
      <div className="grid font-subtext md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-3 my-6">
        <div className=" flex flex-col space-y-4">
          ...
          <div className="bg-white px-6 py-6 rounded-md">
            <h3 className="font-bold py-2 text-[16px]">About Student</h3>
            <p className="text-[13px]">
              ...
              amet, consectetuer adipiscing eli Lorem ipsum dolor sit amet,
