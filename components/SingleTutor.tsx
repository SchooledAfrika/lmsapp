    ...
    <div className="w-[90%] my-6 h-full overflow-hidden flex md:flex-row flex-col">
      <div className="flex flex-col">
        ...
        <div className="flex md:hidden sm:ml-24 mx-10  justify-between sm:my-8 mt-3 md:items-start">
          <p className="mr-2 sm:mr-6 sm:border-2 sm:bg-dimYellow rounded-xl sm:p-3 "> 1 on 1 sessions</p>
          <p className="mr-2 sm:mr-6 sm:border-2 sm:bg-dimYellow rounded-xl sm:p-3 "> Homework Support</p>
          <p className="sm:border-2 sm:bg-dimYellow rounded-xl sm:p-3"> Open to{" "} Jobs</p>
        </div>
       ...
       <div className="flex flex-col w-full mx-3 my-6 justify-between ">
        <div className="md:w-[800px] mx-auto w-[90%] my-5 bg-white md:h-[200px] h-full p-3 rounded-xl">
          <div className="flex md:flex-row flex-col justify-between">
             <p className="bg-dimYellow md:ml-5 ml-2 mt-5  font-header w-[50px] rounded-md text-center py-3 font-bold h-[50px]">SA</p>
             <div className="md:flex-1">
               <h3 className="mt-5 md:ml-5 ml-2 font-bold">Samuel Adenike</h3>
               <p className="md:w-4/5 w-full mt-3 ml-2 md:ml-5">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus...</p>
             </div>
        ...
        <div className="md:w-[800px] w-[90%] mx-auto my-5 bg-white md:h-[200px] h-full p-3  rounded-xl">
          <div className="flex md:flex-row flex-col justify-between">
             <p className="bg-dimYellow md:ml-5 ml-2 mt-5 font-header w-[50px] rounded-md text-center py-3 font-bold h-[50px]">AR</p>
             <div className="flex-1">
               <h3 className="mt-5 md:ml-5 ml-2 font-bold">Amanda Richards</h3>
               <p className="md:w-4/5 w-full mt-3 md:ml-5 ml-2">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus...</p>
             </div>
        ...
        <div className="md:w-[800px] p-3 w-[90%] mx-auto my-5 bg-white md:h-[200px] h-full  rounded-xl">
          <div className="flex md:flex-row flex-col justify-between">
             <p className="bg-dimYellow md:ml-5 ml-2 mt-5 font-header w-[50px] rounded-md text-center py-3 font-bold h-[50px]">UD</p>
             <div className="flex-1">
