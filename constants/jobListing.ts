...
export const JobListingInfo: IprogressType[] = [
  {
    ...
    field: ["jobTitle", "role", "location", "state", "level", "description", "minSalary", "maxSalary"] as const,
  },
...
export const jobListingSchema = z.object({
   ...
   role: z.enum(
    ...
    responsibility: z.array(z.string(), { message: "please enter job responsibilities" }),
    qualifications: z.array(z.string(), { message: "please enter job qualifications" }),
